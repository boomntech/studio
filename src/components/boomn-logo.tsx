  ...
  return (
    ...
    >
      <g fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Wing details */}
        <path d="M38,27 l8,-4" fill="none" stroke="hsl(var(--sidebar-background))" />
        <circle cx="47" cy="22.5" r="1.5" stroke="none" fill="hsl(var(--sidebar-background))" />
        <circle cx="47" cy="22.5" r="0.75" stroke="none" fill="currentColor" />

        <path d="M26,27 l-8,-4" fill="none" stroke="hsl(var(--sidebar-background))" />
        <circle cx="17" cy="22.5" r="1.5" stroke="none" fill="hsl(var(--sidebar-background))" />
        ...
        <path d="M27,45 h10" fill="none" stroke="hsl(var(--sidebar-background))" strokeWidth="2.5" />
